import simshaImg from "../../assets/images/simsha.webp";

export default function CardName() {
  return (
    <div className="flex-1 min-w-[300px] bg-[#e5ecf6] shadow-lg flex flex-col items-center text-center">
      <div className="py-10 px-6 text-center">
        <div className="rounded-full w-40 h-40 overflow-hidden mb-4">
          <img
            src={simshaImg}
            alt="Profile"
            width={160}
      ...
      <div className="flex flex-row space-x-12 justify-center p-4 bg-white w-full ">
        <a
          href="https://github.com/OwenPrasimsha"
          target="_blank"
          rel="noopener noreferrer"
          className="text-[#295e90] hover:text-[#3479b8]"
        >
          <svg
